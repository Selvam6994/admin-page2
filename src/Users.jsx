...
// if the below function is linckd to on click it will render on clicking the assigned button
    let loadData = async () => {
        setLoading(true)
                            ...
                            users.map((user, index) => {
                                return (<tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger mr-2" style={{ color: "white" }}>Delete</button>
                                    </td>
                                </tr>
                                )
                            })
